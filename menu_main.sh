...
function printAddition {
 ...
 function monitor() {
 	bash <(curl -s https://raw.githubusercontent.com/unitynodes/scripts/main/installmonitoring.sh)
}

 function backup() {
 	bash <(curl -s https://raw.githubusercontent.com/unitynodes/backup/main/backup.sh)
}
